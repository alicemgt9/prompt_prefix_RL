...
def load_tokenizer_only(model_size, hf_token=None):
    tokenizer = AutoTokenizer.from_pretrained(f'../../../llama/llama2_7b/llama-2-7b-chat-hf', use_auth_token=hf_token)
    return tokenizer

def load_unemb_only(model_size,model_version):
    if model_size == '70B' or model_size == '70b' and model_version == '2':
        lm_head_state_dict = load_file("../../../llama/llama-2-70b-chat-hf/model-00015-of-00015.safetensors")
        norm_state_dict = load_file("../llama/llama-2-70b-chat-hf/model-00014-of-00015.safetensors")
    if model_size == '7B' or model_size == '7b' and model_version == '2':
        lm_head_state_dict = load_file('../../../llama/llama-2-7b-chat-hf/model-00002-of-00002.safetensors')
        norm_state_dict = lm_head_state_dict 
    if model_size == '13B' or model_size == '13b'and model_version == '2':
        lm_head_state_dict = load_file("../llama/llama-2-13b-chat-hf/model-00003-of-00003.safetensors")
        norm_state_dict = lm_head_state_dict
    if model_size == '8B' or model_size == '8b'and model_version == '3.1':
        lm_head_state_dict = load_file("../llama/llama-3.1-8b-chat-hf/model-00004-of-00004.safetensors")
        norm_state_dict = lm_head_state_dict
    if model_size == '70B' or model_size == '70b'and model_version == '3.1':
        lm_head_state_dict = load_file("../llama/llama-2-13b-chat-hf/model-00003-of-00003.safetensors")
        norm_state_dict = lm_head_state_dict
...
class LlamaHelper:
    ...
    def generate_text(self, prompt,max_length = 600):
